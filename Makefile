...
# 用户态源文件
MAIN_SRCS = src/main.cpp src/config.cpp src/check.cpp src/utils.cpp src/commonfun.cpp src/alert_manager.cpp src/report_generator.cpp  src/baseline_db.cpp
